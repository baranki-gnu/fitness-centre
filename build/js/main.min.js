...
var tabsButtonsList = document.querySelector('[data-tabs-buttons]');
var tabsButtons = Array.from(tabsButtonsList.querySelectorAll('[data-duration]'));
function findActiveButton() {
  var activeButton = tabsButtonsList.querySelector('.exercise-pass__duration-item--active button');
...
function findActiveTab(dataInfo) {
  ...
  var activeTab = tabsList.querySelector('[data-tab=dataInfo]');
...
function switchTab() {
  tabsButtons.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      console.log(activeButton);
      var activeData = activeButton.dataset.duration;
