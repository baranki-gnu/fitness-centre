...
/* harmony import */ var _utils_tabs_switch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/tabs-switch */ "./js/utils/tabs-switch.js");
...
/* harmony import */ var _utils_scroll_to_block__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/scroll-to-block */ "./js/utils/scroll-to-block.js");
/* harmony import */ var _utils_remove_reviews_nojs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/remove-reviews-nojs */ "./js/utils/remove-reviews-nojs.js");
/* harmony import */ var _modules_swiper_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/swiper-slider */ "./js/modules/swiper-slider.js");
/* harmony import */ var _modules_video_play__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/video-play */ "./js/modules/video-play.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_tabs_switch__WEBPACK_IMPORTED_MODULE_2__["switchTab"])();
  Object(_utils_scroll_to_block__WEBPACK_IMPORTED_MODULE_5__["turnScrollOn"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_utils_form_validate__WEBPACK_IMPORTED_MODULE_4__["turnFormValidationOn"])();
    Object(_utils_remove_reviews_nojs__WEBPACK_IMPORTED_MODULE_6__["removeReviewsNoJs"])();
  });
});
...
/*!*************************************!*\
  !*** ./js/modules/swiper-slider.js ***!
  \*************************************/
/*! exports provided: coachSlider, reviewSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var coachSlider = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.coach-slider', {
  // Optional parameters
...
var reviewSlider = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.review-slider', {
  // Optional parameters
  slidesPerView: 1,
  // Navigation arrows
  navigation: {
...
/*!**********************************!*\
  !*** ./js/modules/video-play.js ***!
  \**********************************/
/*! exports provided: onPageLoad, onVideoClick */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onPageLoad", function() { return onPageLoad; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onVideoClick", function() { return onVideoClick; });
...
function onVideoClick() {
  if (videoBlock) {
    var iframeBlock = videoBlock.querySelector('[data-iframe]');
    var videoCover = videoBlock.querySelector('[data-video-cover]');
    var playButton = videoBlock.querySelector('[data-play-button]');
    if (iframeBlock && videoCover && playButton) {
      ...
      var videoSource = iframeBlock.src + '?rel=0&showinfo=0&autoplay=1';
...
var formMain = document.querySelector('[data-form]');
...
/***/ "./js/utils/remove-reviews-nojs.js":
/*!*****************************************!*\
  !*** ./js/utils/remove-reviews-nojs.js ***!
  \*****************************************/
/*! exports provided: removeReviewsNoJs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeReviewsNoJs", function() { return removeReviewsNoJs; });
...
/*!*************************************!*\
  !*** ./js/utils/scroll-to-block.js ***!
  \*************************************/
/*! exports provided: turnScrollOn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "turnScrollOn", function() { return turnScrollOn; });
...
function turnScrollOn() {
  var buyButton = document.querySelector('[data-buy-pass]');
  var exercisePasses = document.querySelector('[data-exercise-pass]');
...
/***/ "./js/utils/tabs-switch.js":
/*!*********************************!*\
  !*** ./js/utils/tabs-switch.js ***!
  \*********************************/
/*! exports provided: switchTab */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function removeNoJs() {
  var durationButtons = document.querySelector('[data-tabs-duration-wrap]');
  if (durationButtons) {
    durationButtons.classList.remove('exercise-pass__duration-wrap--nojs');
  }
  var tabsList = document.querySelector('[data-tabs-content]');
  if (tabsList) {
    tabsList.classList.remove('tab-list--nojs');
    var tabItems = tabsList.querySelectorAll('[data-tab]');
    if (tabItems) {
      tabItems.forEach(function (item) {
        item.classList.remove('tab-list__item--nojs');
      });
    }
    var tabTips = tabsList.querySelectorAll('[data-tab-tip]');
    if (tabTips) {
      tabTips.forEach(function (item) {
...
function switchTab() {
  removeNoJs();
  var tabsButtons = document.querySelectorAll('.exercise-pass__duration-item button');
  if (tabsButtons) {
    tabsButtons.forEach(function (item) {
      item.addEventListener('click', function () {
        ...
        var targetDuration = item.dataset.duration;
        var targetList = document.querySelector(".tab-list__item[data-tab=\"".concat(targetDuration, "\"]"));
        if (targetList) {
...
function Pagination(e) {
  ...
  function p() {
    ...
    if ("bullets" === e.type) {
      ...
      for (var _s21 = 0; _s21 < _i12; _s21 += 1) e.renderBullet ? r += e.renderBullet.call(t, _s21, e.bulletClass) : r += "<".concat(e.bulletElement, " class=\"").concat(e.bulletClass, "\"></").concat(e.bulletElement, ">");
