  ...
  if (tabsButtons) {
    tabsButtons.forEach(function (item) {
      item.addEventListener('click', function () {
        console.log('клик');
        // Если какой-то таб подсвечен - убираешь подсветку.
        ...
        // На текущий таб стаившь полсветку
        // (closest нужен, потому что класс подсветки у тебя на li-шке, а не на кнопке).
        item.closest('.exercise-pass__duration-item').classList.add('exercise-pass__duration-item--active');
        console.log(item);

        // Если есть активный список - отключаем.
