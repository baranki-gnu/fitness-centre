...
var tabsTitlesList = document.querySelector('[data-tabs-titles]');
var tabsItemTitles = tabsTitlesList.querySelectorAll('[data-tab-title]');
var tabsContentList = document.querySelector('[data-tabs-content]');
var tabsContentItems = tabsContentList.querySelectorAll('[data-tab-item]');
var titlesArray = Array.from(tabsItemTitles);
var tabsContentArray = Array.from(tabsContentItems);
...
function switchTab() {
  titlesArray.forEach(function (item, index) {
    item.addEventListener('çlick', function () {
      ...
      if (!item.classList.contains('exercise-pass__duration-item--active')) {
        console.log('здесь');
        var activeTabTitle = tabsTitlesList.querySelector('exercise-pass__duration-item--active');
        ...
        var activeTab = tabsContentItems.querySelector('tab-list__item--current');
